...
from tensorflow.keras.layers import Input, Conv2D, concatenate, Conv2DTranspose, MaxPooling2D, Dropout
from tensorflow.keras.optimizers import Adam
from tensorflow.keras.regularizers import l2
from utils import bce_dice_loss, mean_iou, dice_coef, dice_coef_loss, weighted_BCE_loss
...
def UNetPlusPlus(deep_supervision=False, pretrained_weights=None, input_size=(256, 256, 1), lr=0.0005, num_class=1,
                 bn_axis=3):
